let api = "https://demo2837922.mockable.io/flipkart-compare";
...
const renderProducts = () => {
  ...
  selectedProducts.forEach((product) => {
    if (product === "demo") {
      ...
      divs += `<div class="btn-container"><img src="${compareSummary.images[product]}" /><button class="close" idx="${product}">x</button></div>`;
    }
  });
  divs += "</div>";
